...
#define STRING_CONFIG_H_AUTHOR "(Skynet Manufacturing, Ender-3 Pro SKR Mini E3 v2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro SKR Mini E3 v2"
